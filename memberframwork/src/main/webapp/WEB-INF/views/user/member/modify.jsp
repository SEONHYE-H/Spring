...
$(document).ready(function() {
	...
	$("#modifyBtn").click(function() {
		if ($("#pass").val().trim().length == 0) {
			...
			$("#modifyform").attr("action", "${root}/user/modify.kitri").submit();
		}
	});
});
...
<div class="container" align="center">
	<div class="col-lg-6" align="center">
		...
		<form id="modifyform" method="post" action="">
			...
			<div class="form-group" align="left">
				<label for="">아이디</label>
				<input type="text" class="form-control" id="id" name="id" value="${userInfo.id}" readonly="readonly"> <!-- onkeyup="javascript:idcheck();" -->
				<div id = "idresult"></div>
			</div>
			<div class="form-group" align="left">
			...
			<div class="form-group" align="left">
				...
				<input type="text" class="form-control" id="emailid" name="emailid" value="${userInfo.emailid}" size="25"> @
				<select class="form-control" id="emaildomain" name="emaildomain" value="${userInfo.emaildomain}">
			...
			<%-- <div class="form-group" align="left">
				...
				<select class="form-control" id="tel1" name="tel1" value="${userInfo.tel1}">
				...
				<input type="text" class="form-control" id="tel2" name="tel2"  value="${userInfo.tel2}"> _
				<input type="text" class="form-control" id="tel3" name="tel3"  value="${userInfo.tel3}">
				</div>
			</div> --%>
			<div class="form-group" align="left">
			...
			<div class="form-group" align="center">
				<button type="button" class="btn btn-primary" id="modifyBtn">정보수정</button>	<!-- 1. 유효성검사 onclick = "javascript:register();" -->
